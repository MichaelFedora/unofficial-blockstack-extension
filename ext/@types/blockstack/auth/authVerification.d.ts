 ...
 * @private
 */
export declare function doPublicKeysMatchUsername(token: string, nameLookupURL: string): Promise<any>;
/**
 ...
 *  @private
 */
export declare function verifyAuthRequest(token: string): Promise<any>;
/**
 ...
 * @private
 */
export declare function verifyAuthResponse(token: string, nameLookupURL: string): Promise<any>;
