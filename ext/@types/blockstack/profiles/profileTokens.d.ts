/**
  ...
  */
export declare function signProfileToken(profile: any, privateKey: any, subject?: any, issuer?: any, signingAlgorithm?: string, issuedAt?: Date, expiresAt?: Date): any;
/**
  * Wraps a token for a profile token file
  * @param {String} token - the token to be wrapped
  * @returns {Object} - including `token` and `decodedToken`
  */
export declare function wrapProfileToken(token: any): {
    token: any;
    decodedToken: any;
};
/**
  ...
  */
export declare function verifyProfileToken(token: any, publicKeyOrAddress: any): any;
/**
