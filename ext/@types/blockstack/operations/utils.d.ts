...
export declare function sumOutputValues(txIn: bitcoinjs.Transaction | bitcoinjs.TransactionBuilder): any;
export declare function decodeB40(input: string): any;
/**
 ...
 * @private
 */
export declare function addUTXOsToFund(txBuilderIn: bitcoinjs.TransactionBuilder, utxos: Array<{
    value: number;
    tx_hash: string;
    tx_output_n: number;
